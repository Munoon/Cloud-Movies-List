...
internal class MoviesServiceTest : AbstractTest() {
    ...
    internal fun createMovieWithAvatar() {
        ...
        val createMoviesTo = CreateMoviesTo("Test Movie", "Original Name", "About", CountryCode.US, setOf(MoviesGenres.ACTION), LocalDate.of(2020, 2, 7), "16+", "1:16");
        val createdMovie = moviesService.createMovie(createMoviesTo, MockPart("avatar", avatarFileText.toByteArray()))
